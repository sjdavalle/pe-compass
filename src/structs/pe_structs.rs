...
///
#[derive(
    Debug, Copy, PartialEq, Pread, Pwrite, IOread, IOwrite, SizeWith, Deserialize, Serialize,
)]
#[repr(C)]
...
/// # IMAGE RESOURCE DIRECTORY TABLE
...
#[repr(C)]
pub struct IMAGE_RESOURCE_DIRECTORY_TABLE {
    pub Characteristics: DWORD,
    pub TimeDateStamp: DWORD,
    pub MajorVersion: WORD,
    pub MinorVersion: WORD,
...
impl ::std::clone::Clone for IMAGE_RESOURCE_DIRECTORY_TABLE {
    fn clone(&self) -> Self {
        *self
    }
}
impl IMAGE_RESOURCE_DIRECTORY_TABLE {
    pub fn load_null_resource_directory() -> Self {
        IMAGE_RESOURCE_DIRECTORY_TABLE {
            Characteristics: 0,
            TimeDateStamp: 0,
            MajorVersion: 0,
            MinorVersion: 0,
